...
const LCMap = dynamic(() => import("@/components/lc-map"), {
  ssr: false,
  loading: () => (
    <div className="flex h-[clamp(360px,58vh,560px)] items-center justify-center rounded-2xl border border-border bg-secondary">
...
export function NetworkSection() {
  return (
    <section id="network" className="py-16 sm:py-20 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <Reveal className="mb-8 max-w-3xl sm:mb-12">
          ...
          <h2 className="mt-4 text-3xl font-bold text-display text-foreground sm:text-4xl md:text-6xl">
